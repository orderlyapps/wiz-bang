...
const NetworkPage = lazy(() => import("@base-routes/pages/settings/info/util/app/network/Network"));
  ...
  return (
    <IonTabs>
      <IonRouterOutlet>
        ...
        <Route path="/settings/info/util/app/network" render={lazyPage(NetworkPage)} exact />
